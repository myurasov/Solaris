...
`ai/spec.md`, the pack-level `ai/*.skill.md` stubs (`init`, `refresh`), and the `ai/<plugin>/` overlays - portable, safe to share or hand off) and a **private/local
