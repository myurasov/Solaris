# Solaris v0.29.0 - Specification <!-- omit in toc -->
...
projects/<slug>/                # container (not a git repo)
  ...
  <repo>/                        # THE repo (its own .git); e.g. "source"
    ...
    ai/                          # the ai-pack, embedded in the repo
      engineer.agent.md  engineer.instructions.md  spec.md  manifest.json  defaults.json  rules/  skills/  info/  .memory/  plugins/<plugin>/
