...
Authoritative description of Solaris v0.34.0. Supersedes the 0.1.0-0.33.0 specs (in git history; the latest prior snapshot is
[`spec-v0.33.0.md`](spec-v0.33.0.md)), alongside the original brief [`spec-v0.txt`](spec-v0.txt) and the v0.1.0
