...
# Solaris v0.18.0 - Specification <!-- omit in toc -->
...
**What changed in v0.18.0:** the ai-pack's private memory directory moved from `ai/memory/` to `ai/.memory/` (breaking; migration `0.18.0.md`), and the bundled **nvidia-brev** plugin was added (autonomous Brev cloud-GPU run lifecycle: brev-setup + brev-run skills over a pristine upstream brev-cli mirror).
