...
confirms every write to Kaggle first (see the 0.33.0 history blurb). The bundled `docker-home` plugin runs the
...
with an always-on rule carrying the boundary contract (see the 0.35.0 history blurb).
