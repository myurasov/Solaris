...
- `.version` exists at the project root (the project's own semver - see the Project Version section of
  `ai/{{PRIMARY}}.agent.md`). If missing (pack predates it), offer to seed it: adopt the repo's highest semver
