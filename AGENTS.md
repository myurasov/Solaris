...
Full specification: [`solaris/spec/spec-v0.32.0.md`](solaris/spec/spec-v0.32.0.md).
...
- Versioning (per-file revisions, release-only framework/plugin semver, per-project root `.version`) and file formats: see [`solaris/solaris.agent.md`](solaris/solaris.agent.md). Full conventions + architecture: [`solaris/spec/spec-v0.32.0.md`](solaris/spec/spec-v0.32.0.md).
