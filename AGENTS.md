...
Full specification: [`solaris/spec/spec-v0.16.0.md`](solaris/spec/spec-v0.16.0.md).
...
- Versioning (per-file revisions vs release-only semver), blocked-command wrappers, and file formats: see [`solaris/solaris.agent.md`](solaris/solaris.agent.md). Full conventions + architecture: [`solaris/spec/spec-v0.16.0.md`](solaris/spec/spec-v0.16.0.md).
