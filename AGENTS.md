...
Full specification: [`solaris/spec/spec-v0.25.0.md`](solaris/spec/spec-v0.25.0.md).
...
- Versioning (per-file revisions vs release-only semver) and file formats: see [`solaris/solaris.agent.md`](solaris/solaris.agent.md). Full conventions + architecture: [`solaris/spec/spec-v0.25.0.md`](solaris/spec/spec-v0.25.0.md).
